...
public class ExcelUtil {
     ...
     * @param out 输出流
     */
    public static void exportExcelX(String title,String search,Map<String, String> headMap,JSONArray jsonArray,String datePattern,int colWidth, OutputStream out) {
        if(datePattern==null) datePattern = DEFAULT_DATE_PATTERN;
        // 声明一个工作薄
        ...
        for (Object obj : jsonArray) {
            if(rowIndex == 65535 || rowIndex == 0){
                ...
                titleRow2.createCell(0).setCellValue(search);
...
//        }
    ...
    //Web 导出excel
    public static void downloadExcelFile(String title,String search,Map<String,String> headMap,JSONArray ja,HttpServletResponse response){
        try {
            ByteArrayOutputStream os = new ByteArrayOutputStream();
            ExcelUtil.exportExcelX(title,search,headMap,ja,null,0,os);
